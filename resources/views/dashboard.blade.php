      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">Omset All Time</p>
      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">Tahun ini</p>
                <h5 class="font-weight-bolder mb-0">
                  {{$thisYearOmset}}
                </h5>
              </div>
    ...
    <div class="col-lg-5 mb-lg-0 mb-4">
      <div class="card z-index-2">
        <div class="card-body p-3">
          ...
          <h6 class="ms-2 mt-4 mb-0"> INI CUMA GAMBAR 1 </h6>
