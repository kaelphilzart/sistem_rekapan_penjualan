      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Masa depan itu tergantung pada apa yang sedang kamu lakukan hari ini</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="/register">
                ...
                <div class="mb-3">
                  <input type="number" class="form-control" placeholder="No HP" name="no_hp" id="no_hp" aria-label="No hp" aria-describedby="No HP-addon" value="{{ old('no_hp') }}">
                  @error('no_hp')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Alamat" name="alamat" id="alamat" aria-label="alamat" aria-describedby="alamat-addon" value="{{ old('alamat') }}">
                  @error('alamat')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
